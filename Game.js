/*class Game {
  ...
  start() {
    ...
    r2ocket.addImage("explosion",explosion)
    rocket2.scale = 0.07;
    ...
    var meteorPositions = [
      { x: width / 2 + 250, y: height - 800, image: meteor },
      { x: width / 2 - 150, y: height - 1300, image: meteor },
      { x: width / 2 + 250, y: height - 1800, image: meteor },
      { x: width / 2 - 180, y: height - 2300, image: meteor },
      { x: width / 2, y: height - 2800, image: meteor },
      { x: width / 2 - 180, y: height - 3300, image: meteor },
      { x: width / 2 + 180, y: height - 3300, image: meteor },
      { x: width / 2 + 250, y: height - 3800, image: meteor },
      { x: width / 2 - 150, y: height - 4300, image: meteor },
      { x: width / 2 + 250, y: height - 4800, image: meteor },
      { x: width / 2, y: height - 5300, image: meteor },
      { x: width / 2 - 180, y: height - 5500, image: meteor }
    ];
    this.addSprites(fuels,4,fuelimg,0.02)
    this.addSprites(powercoins,18,powercoinimage,0.09)
    this.addSprites(meteor)
  }
